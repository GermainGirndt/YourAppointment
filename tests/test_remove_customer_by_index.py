...
class test_remove_customer_by_index(QuickTestResources):
	...
	def test_remove_2_customers_by_index_passes(self):
		...
		quick_test_if_num_of_customers_in_registry_equals(0)
	...
	def test_remove_1_customer_by_index_fails_inexisting_index(self):
		...
		number_of_customers_in_registry = self.quick_get_number_of_customers_in_registry()
		...
		self.quick_test_remove_customer_handles_value_error(
				customer_to_be_removed=self.RIGHT_RETURN_CUSTOMER_ID_2,
	...
	def test_remove_1_customer_by_index_fails_type_error(self):
		wrong_input = [5]
		self.quick_test_remove_customer_raises_type_error(wrong_input)
