...
class test_add_student_to_registry(unittest.TestCase):
    ...
    def test_add_1_student_fails_address_street_and_number2(self):
    ...
    def test_add_1_student_fails_address_others(self):
    ...
    def test_add_1_student_fails_address_others2(self):
    ...
    def test_add_1_student_fails_address_state(self):
    ...
    def test_add_1_student_fails_address_state2(self):
